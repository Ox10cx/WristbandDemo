...
public class PlatformPageAdapterPort extends PlatformPageAdapter {
	...
	private static final int DESIGN_LOGO_HEIGHT = 130;
	private static final int DESIGN_PADDING_TOP = 40;
...
//		cellHeight = (screenWidth - sepLineWidth * 3) / LINE_SIZE_P - DensityUtils.dip2px(context, 20);
		cellHeight = (screenWidth - sepLineWidth * 3) / LINE_SIZE_P ;
