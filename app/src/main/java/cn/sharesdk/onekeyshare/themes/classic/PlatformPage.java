...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		// Add Line
		View viewblack = new View(activity);
		lp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, R.dipToPx(activity, 12));
//		line.setBackgroundColor(0xffbfbfbf);
		viewblack.setBackgroundColor(Color.parseColor("#ffffff"));

		llPanel.addView(viewblack, lp);
		View line = new View(activity);
		lp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, R.dipToPx(activity, 1));
//		line.setBackgroundColor(0xffbfbfbf);
		line.setBackgroundColor(Color.parseColor("#e0e0e0"));

		llPanel.addView(line, lp);

		// Add Button
		RelativeLayout rl = new RelativeLayout(activity);
		//rl.setBackgroundResource(R.getResId());
		rl.setGravity(Gravity.CENTER);
		rl.setBackgroundResource(R.getResId(activity, "drawable", "ssdk_selector_other_button_item"));
		...
		//tv.setText(R.getResId(activity, "string", "ssdk_oks_cancel"));
		//tv.setText("cancel");
		//tv.setTextColor(0x000000);
		//tv.setTextColor(R.getResId(activity, "color", "sky_blue_light"));
		tv.setText(R.getResId(activity, "string", "ssdk_cancel_button"));
		...
		lp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, R.dipToPx(activity, 50));
		llPanel.addView(rl, lp);
